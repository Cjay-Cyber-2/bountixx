...
export function Footer() {
  return (
    <footer className="relative bg-cosmos border-t border-cosmos-4 overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-14 py-16 relative">
        <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] gap-12 items-start mb-16">
          {/* Brand */}
          <div className="max-w-[280px]">
            ...
            <p className="font-rajdhani text-sm text-haze-2 leading-relaxed">
              The AI-powered multiplayer challenge arena. Drop any challenge.
              One winner claims the bounty.
            </p>
          </div>
...
function SocialIcon({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <a
      href="#"
      aria-label={label}
      className="cursor-target w-8 h-8 flex items-center justify-center border border-cosmos-4 text-haze-3 hover:text-haze hover:border-haze-3 transition-colors"
    >
      {children}
    </a>
  );
