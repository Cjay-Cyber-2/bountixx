    ...
    <LandingSection>
      <div ref={ref} className={`relative w-full flex flex-col items-center ${LANDING_STACK}`}>
        ...
        >
          ...
          <SectionHeading className="mt-8 md:mt-10 mb-10 md:mb-12">
            AI sets the stage. <Accent>You claim the crown.</Accent>
          </SectionHeading>
          <p className="font-rajdhani text-lg md:text-xl text-haze-2 leading-[1.85] mb-8 md:mb-10 max-w-[52ch] mx-auto">
          ...
          <p className="font-rajdhani text-base md:text-lg text-haze-3 leading-[1.85] max-w-[52ch] mx-auto">
        ...
        <motion.div
          ...
          className={`w-full max-w-5xl mx-auto pt-16 md:pt-24 border-t border-[var(--border-1)] ${LANDING_SUBSTACK}`}
        >
          ...
          <div className="grid sm:grid-cols-2 gap-10 md:gap-12 lg:gap-14 w-full">
            {ANTI_CHEAT.map((ac, i) => {
              const Icon = ac.icon;
              return (
                <motion.div
                  ...
                  className={`${LANDING_SURFACE} flex flex-col items-center text-center gap-6 md:gap-8 rounded-2xl border-2`}
                  style={{
