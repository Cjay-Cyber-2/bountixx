      ...
      <div className={`${LANDING_GUTTERS} relative`}>
        <div className="w-full max-w-2xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="font-rajdhani text-lg md:text-xl text-haze-2 mb-10 md:mb-12 mx-auto max-w-md leading-relaxed"
          >
            No subscription. No card. Start with 500 welcome coins and bring the skill.
          </motion.p>
          ...
          >
            Anti-cheat AI · Coins land instantly
          </motion.p>
        </div>
      </div>
    </section>
